...
//			OutputStream out = response.getOutputStream();
			...
			String sql = "select * from likes where phone = '" + phone + "'";
			...
			for (String string : noteIds) {
				noteList.clear();
				noteList = noteService.getNotes("select * from notes where note_id='" + string + "'");
				System.out.println("MyLikeNoteList::"+noteList.toString());
